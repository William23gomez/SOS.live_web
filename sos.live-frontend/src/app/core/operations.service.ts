...
export class OperationsService {
  ...
  async getHistory() {
    ...
    return this.withTimeout(
      firstValueFrom(this.http.get<HistoryResponse>(`${this.apiUrl}/history`, { headers })),
      'La consulta del historial tardo demasiado. Intenta de nuevo.'
    );
  }
  ...
  async getDashboardSnapshot() {
    ...
    return this.withTimeout(
      firstValueFrom(
        this.http.get<DashboardSnapshotResponse>(`${this.apiUrl}/dashboard-snapshot`, {
          headers,
        })
      ),
      'La sincronizacion del dashboard tardo demasiado. Intenta de nuevo.'
    );
  }
